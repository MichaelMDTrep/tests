...
export const fortmatic_mainnet = new Fortmatic(process.env.REACT_APP_FORTMATIC_MAINNET_API_KEY as string, 'mainnet');
...
// export const portis_ropsten = new Portis(process.env.REACT_APP_PORTIS_DAPP_ID as string, 'ropsten');
