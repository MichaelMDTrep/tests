...
import fortmatic from '../../../assets/png/Fortmatic.png';
import portis from '../../../assets/png/Portis.png';
...
const ConnectWalletModal = (props: any) => {
    ...
    return (
        <>
            {!hidden && (
                <div className={`connect-wallet__div ${props.divClass}`} style={props.style}>
                    ...
                    <div className={`connect-wallet__content ${props.contentClass}`}>
                        <div className="connect-wallet__container">
                            <div className="connect-wallet__cardRecommended connect-wallet__cardRecommendedRed">
                                <div className="connect-wallet__cardRecommendedText">Recommended</div>
                                <div className="connect-wallet__card connect-wallet__cardRed">
                                    <img src={metaMask} alt="MetaMask" className="connect-wallet__cardImg" />
                                    ...
                                    <div className="connect-wallet__cardDescription">
                                        This wallet allow users to purchase Ether with a credit card. It is a browser
                                        extension on Chrome and Firefox, and it has a mobile app.
                                        <br />
                                    ...
                                    <button
                                        ...
                                        onClick={() => {localStorage.setItem('walletType', 'metamask'); handleWalletSignIn();}}
                                    >
                                        CONNECT NOW
                                    </button>
                        ...
                        <div className="connect-wallet__container">
                            <div className="connect-wallet__card connect-wallet__cardPurple">
                                <img src={portis} alt="Portis" className="connect-wallet__cardImg" />
                                ...
                                <div className="connect-wallet__cardDescription">
                                    This wallet is easy to set up and allows users to sign in with an email. Ether can
                                    be purchased through a coinbase exchange and sent to a Portis wallet.
                                </div>
                                <button
                                    className="connect-wallet__cardBtns connect-wallet__purpleBtn"
                                    onClick={() => {localStorage.setItem('walletType', 'portis'); window.location.reload();}}
                                    // disabled={true}
                                >
                                    CONNECT NOW
                                </button>
                        ...
                        <div className="connect-wallet__container">
                            <div className="connect-wallet__card connect-wallet__cardPurple">
                                <img src={fortmatic} alt="Fortmatic" className="connect-wallet__cardImg" />
                                <div className="connect-wallet__cardTitle">Fortmatic</div>
                                <div className="connect-wallet__cardSubTitle connect-wallet__cardBlueText">
                                    Beginner
                                </div>
                                <div className="connect-wallet__cardDescription">
                                    This user-friendly wallet allows users to sign-up with a phone number on any
                                    devices. Ether can be purchased through a coinbase exchange and sent to a Fortmatic
                                    wallet.
                                </div>
                                <button
                                    className="connect-wallet__cardBtns connect-wallet__purpleBtn"
                                    onClick={() => {localStorage.setItem('walletType', 'fortmatic'); window.location.reload();}}
                                    // disabled={true}
                                >
                                    CONNECT NOW
                                </button>
                    ...
                    <footer className={`connect-wallet__footer ${props.footerClass}`}>{props.footer}</footer>
                </div>
            )}
        </>
    );
